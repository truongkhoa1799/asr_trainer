...
def create_manifest(config):
    ...
    for data_directory_name in data_directory.iterdir():
        LOGGER.log_info(f"\tCreating manifest for {data_directory_name.name}")
        
        list_audio_path = list(data_directory_name.glob("wav/*.wav"))
        transcript_path = data_directory_name.joinpath("transcript.txt")
